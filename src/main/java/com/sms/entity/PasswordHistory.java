...
public class PasswordHistory {
   ...
   public String toString() {
      return "PasswordHistory [userid=" + this.userid + ", password_type=" + this.password_type + ", old_passwd=" + this.old_passwd + ", new_passwd=" + this.new_passwd + ", changetime=" + this.changetime + "]";
   }
}
